# ColdVPN — How a packet travels (Mac → 1.1.1.1, via Oracle)

🔗 [Main README](../README.md) · 🏗️ [Architecture & decisions](ARCHITECTURE.md) · ☁️ [Creating the server](../server/CREATE-VM.md)
